  ...
  return (
    <div id='home' className='w-full h-screen text-center'>
      <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
        <div>
          <p className='text-sm uppercase text-gray-600 tracking-widest'>Let's Built Somthing Amazing</p>
          <h1 className='text-gray-700 py-4'>Hi, I'm <span className='text-[#5651e5]'>Hussain</span></h1>
          ...
          <div className='flex justify-between items-center max-w-[230px] md:max-w-[330px] sm:max-w-[280px] m-auto py-4'>
            <div className='rounded-full p-3 sm:p-4 sm:p-4 md:p-6 shadow-lg shadow-gray-400 text-[#5651e5] hover:scale-110'>
              <GrLinkedinOption />
            </div>

    ...
    <div id='about' className='w-full md:h-screen p-2 py-16 flex items-center'>
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='col-span-2'>
          <p className='text-[#5651e5] text-xl uppercase tracking-widest font-semibold'>About</p>
        ...
        <div className=' w-full h-auto m-auto shadow-xl shadow-gray-400 rounded-xl flex items-center justify-center hover:scale-110 p-4 ease-in duration-300'>
          <Image src={aboutImage} className='object-fit rounded-xl h-full w-full ' alt='about Image'/>
        </div>
      </div>
    </div>
  )
